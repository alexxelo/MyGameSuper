...
import com.first.core.feature.game.tipshop.free.ads.TipsForAdsVM.Companion.TIPS_FOR_AD
...
fun TipsForAds(
  ...
  Column(modifier = modifier.padding(vertical = 32.dp)) {
    Row(
      ...
      Text(
        text = stringResource(com.first.core.R.string.tips_for_ads_description),
//        style = MaterialTheme.typography.bodyMedium,
    ...
    Row(
      ...
      Text(text = stringResource(id = com.first.core.R.string.tips_amount, TIPS_FOR_AD))

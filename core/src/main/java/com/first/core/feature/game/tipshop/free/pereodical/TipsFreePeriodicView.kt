...
import com.first.core.utils.getDefaultLocaleCompose
...
fun TipsFreePeriodicView(
  ...
  Column(modifier = modifier) {
    ...
    Row(modifier = modifier) {
      Text(
        text = stringResource(id = com.first.core.R.string.tips_amount, TipsPeriodicVM.FREE_TIPS),
      )
      ...
      Button(
        ...
        Text(
          text = if (secondsToRestore > 0) {
            ...
            stringResource(id = com.first.core.R.string.obtain)
          }
        )
      }
    }
    Text(
      text = stringResource(com.first.core.R.string.tips_periodic_description),

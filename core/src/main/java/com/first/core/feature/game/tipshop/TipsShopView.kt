...
import com.first.core.feature.game.tipshop.free.ads.TipsForAds
import com.first.core.feature.game.tipshop.free.pereodical.TipsFreePeriodicView
...
fun TipsShopView(
  ...
  Column(
    ...
    Row(modifier = modifier.fillMaxWidth()) {
      ...
      Text(text = stringResource(id = com.first.core.R.string.antimatter_info))
